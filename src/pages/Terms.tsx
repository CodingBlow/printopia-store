  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 prose prose-slate max-w-4xl">
        ...
        <section className="mb-8">
          <h2>Use License</h2>
          <p>Permission is granted to temporarily download one copy of the materials (information or software) on PrintTech's website for personal, non-commercial transitory viewing only.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>Orders are typically processed within 1-2 business days. Shipping times vary depending on the selected method and destination.</p>
        </section>
      </main>
      <Footer />
    </div>
